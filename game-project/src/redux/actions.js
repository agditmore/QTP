...
export const changeCharacterImage = payload => ({
  type: CHANGE_CHARACTER_IMAGE,
  payload,
});
export const updatePlayerTurn = payload => ({
  type: UPDATE_PLAYER_TURN,
  payload,
});
export const changePlayerScore = payload => ({
  type: CHANGE_PLAYER_SCORE,
  payload,
});
export const changeComputerScore = payload => ({
  type: CHANGE_COMPUTER_SCORE,
  payload,
});
...
export const changeChallengeQuestions = payload => ({
  type: CHANGE_CHALLENGE_QUESTIONS,
  payload,
});
export const addKrakenQuestion = payload => ({
  type: ADD_KRAKEN_QUESTION,
  payload,
});
